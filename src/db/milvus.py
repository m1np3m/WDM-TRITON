...
client = MilvusClient(uri="milvus_db/milvus.db")
milvus_colbert_retriever = MilvusColbertRetriever(client, "m3docvqa_500")
print("Loaded Milvus client and collection")
